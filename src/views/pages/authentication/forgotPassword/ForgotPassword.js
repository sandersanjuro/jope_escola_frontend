...
const ForgotPassword = ({ ...others }) => {
    ...
    let slitToken = location.search.split('&email=');
    let token = slitToken[0].split('?token=')[1];
    ...
    const [data, setData] = useState({ email: email, password: '', showPassword: false, password_confirmation: '', token: token });
                                        ...
                                        <Formik
                                            ...
                                            onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                                                try {
                                                    ...
                                                    setLoading(true);
                                                    updatePasswordRemember(submiteData)
                                                        .then((resp) => {
                                                            console.log(resp);
                                                            setError('');
