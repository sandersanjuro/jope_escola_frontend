            ...
            <Formik
                ...
                onSubmit={async (values, { setErrors, setStatus, setSubmitting, resetForm }) => {
                    try {
                        ...
                        setLoading(true);
                        let operating = idOperating.length <= 0 || !idOperating ? [currentOperating] : idOperating;
                        ...
                        const data = {
                            ...
                            nature_of_operation:
                                moduleOs === 1 ? values.nature_of_operation : options.natureOfOperation.filter((desc) => desc.id === 11)[0]
                        };
